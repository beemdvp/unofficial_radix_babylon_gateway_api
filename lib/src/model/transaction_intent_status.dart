...
class TransactionIntentStatus extends EnumClass {
  ...
  static const TransactionIntentStatus commitPendingOutcomeUnknown =
      _$commitPendingOutcomeUnknown;

  /// A more specific intent status. See the description field for further information. Note that `CommitPendingOutcomeUnknown` can either result in `CommittedSuccess` or `CommittedFailure`.
  @BuiltValueEnumConst(wireName: r'PermanentlyRejected')
  static const TransactionIntentStatus permanentlyRejected =
      _$permanentlyRejected;

  /// A more specific intent status. See the description field for further information. Note that `CommitPendingOutcomeUnknown` can either result in `CommittedSuccess` or `CommittedFailure`.
  @BuiltValueEnumConst(wireName: r'LikelyButNotCertainRejection')
  static const TransactionIntentStatus likelyButNotCertainRejection =
  ...
  static Serializer<TransactionIntentStatus> get serializer =>
      _$transactionIntentStatusSerializer;
...
abstract class TransactionIntentStatusMixin = Object
    with _$TransactionIntentStatusMixin;

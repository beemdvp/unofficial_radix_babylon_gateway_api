...
@BuiltValue()
abstract class StreamTransactionsRequestEventFilterItem
    implements
        Built<StreamTransactionsRequestEventFilterItem,
  ...
  factory StreamTransactionsRequestEventFilterItem(
          [void updates(StreamTransactionsRequestEventFilterItemBuilder b)]) =
      _$StreamTransactionsRequestEventFilterItem;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(StreamTransactionsRequestEventFilterItemBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<StreamTransactionsRequestEventFilterItem> get serializer =>
      _$StreamTransactionsRequestEventFilterItemSerializer();
}

class _$StreamTransactionsRequestEventFilterItemSerializer
    implements PrimitiveSerializer<StreamTransactionsRequestEventFilterItem> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.event,
      specifiedType:
          const FullType(StreamTransactionsRequestEventFilterItemEventEnum),
    );
...
class StreamTransactionsRequestEventFilterItemEventEnum extends EnumClass {
  ...
  static const StreamTransactionsRequestEventFilterItemEventEnum deposit =
      _$streamTransactionsRequestEventFilterItemEventEnum_deposit;
  @BuiltValueEnumConst(wireName: r'Withdrawal')
  static const StreamTransactionsRequestEventFilterItemEventEnum withdrawal =
      _$streamTransactionsRequestEventFilterItemEventEnum_withdrawal;

  static Serializer<StreamTransactionsRequestEventFilterItemEventEnum>
      get serializer =>
          _$streamTransactionsRequestEventFilterItemEventEnumSerializer;

  const StreamTransactionsRequestEventFilterItemEventEnum._(String name)
      : super(name);

  static BuiltSet<StreamTransactionsRequestEventFilterItemEventEnum>
      get values => _$streamTransactionsRequestEventFilterItemEventEnumValues;
  static StreamTransactionsRequestEventFilterItemEventEnum valueOf(
          String name) =>
      _$streamTransactionsRequestEventFilterItemEventEnumValueOf(name);
}

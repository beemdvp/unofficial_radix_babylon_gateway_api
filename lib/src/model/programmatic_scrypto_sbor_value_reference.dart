...
part 'programmatic_scrypto_sbor_value_reference.g.dart';
...
abstract class ProgrammaticScryptoSborValueReference
  ...
  static void _defaults(ProgrammaticScryptoSborValueReferenceBuilder b) =>
      b..kind = ProgrammaticScryptoSborValueKind.reference;
...
class _$ProgrammaticScryptoSborValueReferenceSerializer
  ...
  void _deserializeProperties(
    ...
    required ProgrammaticScryptoSborValueReferenceBuilder result,
  ...
  @override
  ProgrammaticScryptoSborValueReference deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ProgrammaticScryptoSborValueReferenceBuilder();

...
/// * [value]
@BuiltValue()
abstract class ProgrammaticScryptoSborValueBool
    implements
        ProgrammaticScryptoSborValue,
        Built<ProgrammaticScryptoSborValueBool,
  ...
  factory ProgrammaticScryptoSborValueBool(
          [void updates(ProgrammaticScryptoSborValueBoolBuilder b)]) =
      _$ProgrammaticScryptoSborValueBool;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ProgrammaticScryptoSborValueBoolBuilder b) =>
      b..kind = ProgrammaticScryptoSborValueKind.bool_;

  @BuiltValueSerializer(custom: true)
  static Serializer<ProgrammaticScryptoSborValueBool> get serializer =>
      _$ProgrammaticScryptoSborValueBoolSerializer();
}

class _$ProgrammaticScryptoSborValueBoolSerializer
    implements PrimitiveSerializer<ProgrammaticScryptoSborValueBool> {
  @override

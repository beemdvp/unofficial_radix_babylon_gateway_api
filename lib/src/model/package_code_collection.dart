...
part 'package_code_collection.g.dart';
...
class _$PackageCodeCollectionSerializer implements PrimitiveSerializer<PackageCodeCollection> {
  ...
  @override
  PackageCodeCollection deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
...
class _$$PackageCodeCollectionSerializer implements PrimitiveSerializer<$PackageCodeCollection> {
  ...
  void _deserializeProperties(
    ...
    required PackageCodeCollectionBuilder result,
  ...
  $PackageCodeCollection deserialize(
    ...
    final result = $PackageCodeCollectionBuilder();

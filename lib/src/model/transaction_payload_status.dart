...
class TransactionPayloadStatus extends EnumClass {
  ...
  static const TransactionPayloadStatus commitPendingOutcomeUnknown =
      _$commitPendingOutcomeUnknown;

  /// A more specific payload status. See the description field for further information.
  @BuiltValueEnumConst(wireName: r'PermanentlyRejected')
  static const TransactionPayloadStatus permanentlyRejected =
      _$permanentlyRejected;

  /// A more specific payload status. See the description field for further information.
  @BuiltValueEnumConst(wireName: r'TemporarilyRejected')
  static const TransactionPayloadStatus temporarilyRejected =
  ...
  static Serializer<TransactionPayloadStatus> get serializer =>
      _$transactionPayloadStatusSerializer;
...
abstract class TransactionPayloadStatusMixin = Object
    with _$TransactionPayloadStatusMixin;

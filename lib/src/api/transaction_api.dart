...
class TransactionApi {
  ...
  Future<Response<AccountDepositPreValidationResponse>> accountDepositPreValidation({ 
    ...
    final _path = r'/transaction/account-deposit-pre-validation';
    ...
    AccountDepositPreValidationResponse? _responseData;
    ...
    return Response<AccountDepositPreValidationResponse>(
      data: _responseData,
  ...
  Future<Response<TransactionCommittedDetailsResponse>> transactionCommittedDetails({ 
    ...
    final _path = r'/transaction/committed-details';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    TransactionCommittedDetailsResponse? _responseData;
    ...
    return Response<TransactionCommittedDetailsResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<TransactionConstructionResponse>> transactionConstruction({ 
    ...
    final _path = r'/transaction/construction';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    TransactionConstructionResponse? _responseData;
    ...
    return Response<TransactionConstructionResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<TransactionPreviewResponse>> transactionPreview({ 
    ...
    final _path = r'/transaction/preview';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    TransactionPreviewResponse? _responseData;
    ...
    return Response<TransactionPreviewResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<TransactionStatusResponse>> transactionStatus({ 
    ...
    final _path = r'/transaction/status';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<TransactionSubmitResponse>> transactionSubmit({ 
    ...
    final _path = r'/transaction/submit';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    TransactionSubmitResponse? _responseData;
    ...
    return Response<TransactionSubmitResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,

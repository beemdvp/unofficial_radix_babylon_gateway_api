...
class StatusApi {
  ...
  Future<Response<GatewayStatusResponse>> gatewayStatus({ 
    ...
    final _path = r'/status/gateway-status';
    ...
    GatewayStatusResponse? _responseData;
    ...
    return Response<GatewayStatusResponse>(
      data: _responseData,
  ...
  Future<Response<NetworkConfigurationResponse>> networkConfiguration({ 
    ...
    final _path = r'/status/network-configuration';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    NetworkConfigurationResponse? _responseData;
    ...
    return Response<NetworkConfigurationResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,

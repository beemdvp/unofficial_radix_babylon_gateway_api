...
class StateApi {
  ...
  Future<Response<StateAccountAuthorizedDepositorsPageResponse>> accountAuthorizedDepositorsPage({ 
    ...
    final _path = r'/state/account/page/authorized-depositors';
    ...
    StateAccountAuthorizedDepositorsPageResponse? _responseData;
    ...
    return Response<StateAccountAuthorizedDepositorsPageResponse>(
      data: _responseData,
  ...
  Future<Response<StateAccountLockerPageVaultsResponse>> accountLockerVaultsPage({ 
    ...
    final _path = r'/state/account-locker/page/vaults';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    StateAccountLockerPageVaultsResponse? _responseData;
    ...
    return Response<StateAccountLockerPageVaultsResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<StateAccountLockersTouchedAtResponse>> accountLockersTouchedAt({ 
    ...
    final _path = r'/state/account-lockers/touched-at';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    StateAccountLockersTouchedAtResponse? _responseData;
    ...
    return Response<StateAccountLockersTouchedAtResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<StateAccountResourcePreferencesPageResponse>> accountResourcePreferencesPage({ 
    ...
    final _path = r'/state/account/page/resource-preferences';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    StateAccountResourcePreferencesPageResponse? _responseData;
    ...
    return Response<StateAccountResourcePreferencesPageResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<StateEntityFungibleResourceVaultsPageResponse>> entityFungibleResourceVaultPage({ 
    ...
    final _path = r'/state/entity/page/fungible-vaults/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    StateEntityFungibleResourceVaultsPageResponse? _responseData;
    ...
    return Response<StateEntityFungibleResourceVaultsPageResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<StateEntityFungiblesPageResponse>> entityFungiblesPage({ 
    ...
    final _path = r'/state/entity/page/fungibles/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    StateEntityFungiblesPageResponse? _responseData;
    ...
    return Response<StateEntityFungiblesPageResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<StateEntityMetadataPageResponse>> entityMetadataPage({ 
    ...
    final _path = r'/state/entity/page/metadata';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    StateEntityMetadataPageResponse? _responseData;
    ...
    return Response<StateEntityMetadataPageResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<StateEntityNonFungibleIdsPageResponse>> entityNonFungibleIdsPage({ 
    ...
    final _path = r'/state/entity/page/non-fungible-vault/ids';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    StateEntityNonFungibleIdsPageResponse? _responseData;
    ...
    return Response<StateEntityNonFungibleIdsPageResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<StateEntityNonFungibleResourceVaultsPageResponse>> entityNonFungibleResourceVaultPage({ 
    ...
    final _path = r'/state/entity/page/non-fungible-vaults/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    StateEntityNonFungibleResourceVaultsPageResponse? _responseData;
    ...
    return Response<StateEntityNonFungibleResourceVaultsPageResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<StateEntityNonFungiblesPageResponse>> entityNonFungiblesPage({ 
    ...
    final _path = r'/state/entity/page/non-fungibles/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    StateEntityNonFungiblesPageResponse? _responseData;
    ...
    return Response<StateEntityNonFungiblesPageResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<StateEntitySchemaPageResponse>> entitySchemaPage({ 
    ...
    final _path = r'/state/entity/page/schemas';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    StateEntitySchemaPageResponse? _responseData;
    ...
    return Response<StateEntitySchemaPageResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<StateKeyValueStoreDataResponse>> keyValueStoreData({ 
    ...
    final _path = r'/state/key-value-store/data';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    StateKeyValueStoreDataResponse? _responseData;
    ...
    return Response<StateKeyValueStoreDataResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<StateKeyValueStoreKeysResponse>> keyValueStoreKeys({ 
    ...
    final _path = r'/state/key-value-store/keys';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    StateKeyValueStoreKeysResponse? _responseData;
    ...
    return Response<StateKeyValueStoreKeysResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<StateNonFungibleDataResponse>> nonFungibleData({ 
    ...
    final _path = r'/state/non-fungible/data';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    StateNonFungibleDataResponse? _responseData;
    ...
    return Response<StateNonFungibleDataResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<StateNonFungibleIdsResponse>> nonFungibleIds({ 
    ...
    final _path = r'/state/non-fungible/ids';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    StateNonFungibleIdsResponse? _responseData;
    ...
    return Response<StateNonFungibleIdsResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<StateNonFungibleLocationResponse>> nonFungibleLocation({ 
    ...
    final _path = r'/state/non-fungible/location';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    StateNonFungibleLocationResponse? _responseData;
    ...
    return Response<StateNonFungibleLocationResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<StatePackageBlueprintPageResponse>> packageBlueprintPage({ 
    ...
    final _path = r'/state/package/page/blueprints';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    StatePackageBlueprintPageResponse? _responseData;
    ...
    return Response<StatePackageBlueprintPageResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<StatePackageCodePageResponse>> packageCodePage({ 
    ...
    final _path = r'/state/package/page/codes';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    StatePackageCodePageResponse? _responseData;
    ...
    return Response<StatePackageCodePageResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<StateEntityDetailsResponse>> stateEntityDetails({ 
    ...
    final _path = r'/state/entity/details';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    StateEntityDetailsResponse? _responseData;
    ...
    return Response<StateEntityDetailsResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<StateValidatorsListResponse>> stateValidatorsList({ 
    ...
    final _path = r'/state/validators/list';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    StateValidatorsListResponse? _responseData;
    ...
    return Response<StateValidatorsListResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,

...
// tests for StateAccountResourcePreferencesPageResponse
void main() {
  final instance = StateAccountResourcePreferencesPageResponseBuilder();
  // TODO add properties to the builder and call build()

  group(StateAccountResourcePreferencesPageResponse, () {
    ...
    // BuiltList<AccountResourcePreferencesResponseItem> items

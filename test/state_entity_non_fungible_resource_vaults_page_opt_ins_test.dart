...
// tests for StateEntityNonFungibleResourceVaultsPageOptIns
void main() {
  final instance = StateEntityNonFungibleResourceVaultsPageOptInsBuilder();
  // TODO add properties to the builder and call build()

  group(StateEntityNonFungibleResourceVaultsPageOptIns, () {

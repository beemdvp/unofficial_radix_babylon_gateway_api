...
// tests for TransactionFungibleFeeBalanceChanges
void main() {
  final instance = TransactionFungibleFeeBalanceChangesBuilder();
  // TODO add properties to the builder and call build()

  group(TransactionFungibleFeeBalanceChanges, () {
    // TransactionFungibleFeeBalanceChangeType type

...
// tests for StateNonFungibleLocationResponse
void main() {
  final instance = StateNonFungibleLocationResponseBuilder();
  // TODO add properties to the builder and call build()

  group(StateNonFungibleLocationResponse, () {
    ...
    // BuiltList<StateNonFungibleLocationResponseItem> nonFungibleIds

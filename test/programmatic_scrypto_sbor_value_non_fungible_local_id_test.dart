...
// tests for ProgrammaticScryptoSborValueNonFungibleLocalId
void main() {
  final instance = ProgrammaticScryptoSborValueNonFungibleLocalIdBuilder();
  // TODO add properties to the builder and call build()

  group(ProgrammaticScryptoSborValueNonFungibleLocalId, () {

...
// tests for StatePackageBlueprintPageResponse
void main() {
  final instance = StatePackageBlueprintPageResponseBuilder();
  // TODO add properties to the builder and call build()

  group(StatePackageBlueprintPageResponse, () {
    ...
    // BuiltList<PackageBlueprintCollectionItem> items

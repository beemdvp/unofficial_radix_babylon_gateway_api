...
// tests for StateEntityMetadataPageResponse
void main() {
  final instance = StateEntityMetadataPageResponseBuilder();
  // TODO add properties to the builder and call build()

  group(StateEntityMetadataPageResponse, () {
    ...
    // BuiltList<EntityMetadataItem> items

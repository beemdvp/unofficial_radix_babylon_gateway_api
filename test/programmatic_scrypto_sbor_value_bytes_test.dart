...
// tests for ProgrammaticScryptoSborValueBytes
void main() {
  final instance = ProgrammaticScryptoSborValueBytesBuilder();
  // TODO add properties to the builder and call build()

  group(ProgrammaticScryptoSborValueBytes, () {
    ...
    // String hex
    test('to test the property `hex`', () async {
      // TODO
    });
  });
}

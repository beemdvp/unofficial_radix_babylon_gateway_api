...
// tests for ProgrammaticScryptoSborValuePreciseDecimal
void main() {
  final instance = ProgrammaticScryptoSborValuePreciseDecimalBuilder();
  // TODO add properties to the builder and call build()

  group(ProgrammaticScryptoSborValuePreciseDecimal, () {

...
// tests for StatePackageCodePageResponse
void main() {
  final instance = StatePackageCodePageResponseBuilder();
  // TODO add properties to the builder and call build()

  group(StatePackageCodePageResponse, () {
    ...
    // BuiltList<PackageCodeCollectionItem> items

...
// tests for StateEntityFungibleResourceVaultsPageRequest
void main() {
  final instance = StateEntityFungibleResourceVaultsPageRequestBuilder();
  // TODO add properties to the builder and call build()

  group(StateEntityFungibleResourceVaultsPageRequest, () {

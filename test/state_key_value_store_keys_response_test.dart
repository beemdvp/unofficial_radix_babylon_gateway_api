...
// tests for StateKeyValueStoreKeysResponse
void main() {
  final instance = StateKeyValueStoreKeysResponseBuilder();
  // TODO add properties to the builder and call build()

  group(StateKeyValueStoreKeysResponse, () {
    ...
    // BuiltList<StateKeyValueStoreKeysResponseItem> items

...
// tests for StateEntityNonFungiblesPageResponse
void main() {
  final instance = StateEntityNonFungiblesPageResponseBuilder();
  // TODO add properties to the builder and call build()

  group(StateEntityNonFungiblesPageResponse, () {
    ...
    // BuiltList<NonFungibleResourcesCollectionItem> items

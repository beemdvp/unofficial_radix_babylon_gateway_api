...
// tests for StateAccountAuthorizedDepositorsPageRequest
void main() {
  final instance = StateAccountAuthorizedDepositorsPageRequestBuilder();
  // TODO add properties to the builder and call build()

  group(StateAccountAuthorizedDepositorsPageRequest, () {

...
// tests for StateAccountAuthorizedDepositorsPageResponse
void main() {
  final instance = StateAccountAuthorizedDepositorsPageResponseBuilder();
  // TODO add properties to the builder and call build()

  group(StateAccountAuthorizedDepositorsPageResponse, () {
    ...
    // BuiltList<AccountAuthorizedDepositorsResponseItem> items

...
// tests for ProgrammaticScryptoSborValueTuple
void main() {
  final instance = ProgrammaticScryptoSborValueTupleBuilder();
  // TODO add properties to the builder and call build()

  group(ProgrammaticScryptoSborValueTuple, () {
    ...
    // BuiltList<ProgrammaticScryptoSborValue> fields

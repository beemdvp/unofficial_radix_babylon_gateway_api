...
// tests for ProgrammaticScryptoSborValueArray
void main() {
  final instance = ProgrammaticScryptoSborValueArrayBuilder();
  // TODO add properties to the builder and call build()

  group(ProgrammaticScryptoSborValueArray, () {
    ...
    // ProgrammaticScryptoSborValueKind elementKind
    test('to test the property `elementKind`', () async {
      // TODO
    });

    // String elementTypeName
    test('to test the property `elementTypeName`', () async {
      // TODO
    });

    // BuiltList<ProgrammaticScryptoSborValue> elements

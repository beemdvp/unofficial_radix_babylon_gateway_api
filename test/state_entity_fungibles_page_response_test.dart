...
// tests for StateEntityFungiblesPageResponse
void main() {
  final instance = StateEntityFungiblesPageResponseBuilder();
  // TODO add properties to the builder and call build()

  group(StateEntityFungiblesPageResponse, () {
    ...
    // BuiltList<FungibleResourcesCollectionItem> items

...
// tests for StateAccountResourcePreferencesPageRequest
void main() {
  final instance = StateAccountResourcePreferencesPageRequestBuilder();
  // TODO add properties to the builder and call build()

  group(StateAccountResourcePreferencesPageRequest, () {

...
// tests for StateEntityFungiblesPageRequest
void main() {
  final instance = StateEntityFungiblesPageRequestBuilder();
  // TODO add properties to the builder and call build()

  group(StateEntityFungiblesPageRequest, () {
    ...
    // StateEntityFungiblesPageRequestOptIns optIns

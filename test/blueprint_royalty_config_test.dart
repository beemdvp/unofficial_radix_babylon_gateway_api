...
// tests for BlueprintRoyaltyConfig
void main() {
  final instance = BlueprintRoyaltyConfigBuilder();
  // TODO add properties to the builder and call build()

  group(BlueprintRoyaltyConfig, () {
    // bool isEnabled
    ...
    // BuiltList<BlueprintMethodRoyalty> methodRules
    test('to test the property `methodRules`', () async {
      // TODO
    });

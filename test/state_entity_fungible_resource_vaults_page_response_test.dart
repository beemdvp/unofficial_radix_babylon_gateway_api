...
// tests for StateEntityFungibleResourceVaultsPageResponse
void main() {
  final instance = StateEntityFungibleResourceVaultsPageResponseBuilder();
  // TODO add properties to the builder and call build()

  group(StateEntityFungibleResourceVaultsPageResponse, () {

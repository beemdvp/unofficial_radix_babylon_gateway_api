...
// tests for StateEntityNonFungibleResourceVaultsPageRequest
void main() {
  final instance = StateEntityNonFungibleResourceVaultsPageRequestBuilder();
  // TODO add properties to the builder and call build()

  group(StateEntityNonFungibleResourceVaultsPageRequest, () {
    ...
    // StateEntityNonFungibleResourceVaultsPageOptIns optIns
